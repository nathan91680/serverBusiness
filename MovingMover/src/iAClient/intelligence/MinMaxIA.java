...
public class MinMaxIA extends GenericIA{

	public MinMaxIA(ArrayList<String> gameData){
	...
	private String minMax(ArrayList<String> inputData, int profondeur){
		...
		for(int i=0 ; i<4 ; i++) { //deplacement
			...
			for(int j=0 ; j<5 ; j++){ //fleche
				...
				//j==4 signifie pas de fleche
				
				for(int k=0 ; k<4 ; k++){ //sens fleche
					
					if (j==4 && k != 0) // cas redondants car si pas de fleche ne pas checker tous les sens 
						continue;
		...
		if(maxj == 0)
			result += "\nArrow " + String.valueOf(posPlayers.get(0).get(0) + 1) + " " + String.valueOf(posPlayers.get(0).get(1)) + " " + arrows.get(maxk);				
		else if(maxj == 1)
			result += "\nArrow " + String.valueOf(posPlayers.get(0).get(0) - 1) + " " + String.valueOf(posPlayers.get(0).get(1)) + " " + arrows.get(maxk);				
		else if(maxj == 2)
			result += "\nArrow " + String.valueOf(posPlayers.get(0).get(0)) + " " + String.valueOf(posPlayers.get(0).get(1) + 1) + " " + arrows.get(maxk);				
		else if(maxj == 3)
			result += "\nArrow " + String.valueOf(posPlayers.get(0).get(0)) + " " + String.valueOf(posPlayers.get(0).get(1) - 1) + " " + arrows.get(maxk);				
		/*else if(maxj == 4)
