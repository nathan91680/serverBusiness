...
public class AlphaBetaIA1action extends GenericIA{

	public AlphaBetaIA1action(ArrayList<String> gameData){
	...
	private String minMax(ArrayList<String> inputData, int profondeur){
		...
		for(int j=0 ; j<4 ; j++){ //fleche
			...
			for(int k=0 ; k<4 ; k++){ //sens fleche
				...
				// simu 
				tmp = min(profondeur-1, max);//etatJeu
	...
	private int min(int profondeur, int alpha){
